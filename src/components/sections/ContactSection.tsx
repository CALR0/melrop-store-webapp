...
const ContactSection: React.FC = () => {
  return (
    <section className="pt-24 pb-20 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      {/* Background elements optimizados */}
      <div className="absolute inset-0">
        ...
        <motion.div
          animate={{
            y: [20, -20, 20],
            transition: { duration: 10, repeat: Infinity, ease: "easeInOut" } // Más lento
          }}
        ...
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.1, 0.3, 0.1],
            transition: { duration: 6, repeat: Infinity, ease: "easeInOut" } // Más lento
          }}
      ...
      {/* Iconos flotantes simplificados */}
      <motion.div
        animate={{
          y: [-15, 15, -15],
          rotate: [0, 180, 360],
      ...
      <motion.div
        animate={{
          y: [10, -10, 10],
          rotate: [360, 0],
          transition: { duration: 10, repeat: Infinity, ease: "linear" } // Más lento
        }}
